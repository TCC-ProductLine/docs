...
Como pode ser visto no processo apresentado na Figura \ref{processo tcc}, existem duas etapas  envolvendo desenvolvimento, no caso: ``Desenvolver o \textit{Framework}'' e ``Desenvolver a Redo Social''. Cada uma dessas etapas, segue um Processo alternativo, como mostrado na Figura \ref{Processo desenvolvimento}.
