...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.6]{figuras/capitulo4/factory_method.eps}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.45]{figuras/capitulo4/abstract_factory.eps}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.45]{figuras/capitulo4/strategy.eps}
