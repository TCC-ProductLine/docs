...
A partir das pesquisas realizadas e documentadas no capítulo de \nameref{apend_chap:metodologia} do apêndice, pode-se definir a metodologia que será aplicada. Este trabalho possui metodologias específicas para a realização do levantamento bibliográfico e do desenvolvimento das aplicações propostas.
