...
Para o método ``search'', que é responsável por fazer pesquisas no grafo, foram feitas 3 tipos de pesquisas. A pesquisa padrão é uma pesquisa na qual será encontrado o os vértices até o segundo nível do grafo. A pesquisa no terceiro nível é uma pesquisa que irá percorrer até o último nível do grafo. A pesquisa inválida é uma pesquisa não será encontrado resultados no grafo e também não será encontrado no banco de dados, portanto todos os registros serão verificados. Pode-se visualizar o resultado dessas pesquisas na Figura \ref{search_tempo}.
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.8]{figuras/capitulo7/graficos/schedule/tempo/dias/31dias_tempo.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.8]{figuras/capitulo7/graficos/schedule/memoria/dias/31dias_memoria.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.8]{figuras/capitulo7/graficos/schedule/tempo/users/500users_tempo.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.8]{figuras/capitulo7/graficos/schedule/memoria/users/500users_memoria.eps}
