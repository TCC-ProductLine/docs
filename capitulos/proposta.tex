...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.55]{figuras/proposta/amigo.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.55]{figuras/proposta/parentes.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.55]{figuras/proposta/rota.eps}
...
O \textit{framework} é \textit{open sorce}, desenvolvido em \textit{``Ruby on Rails''}, e tem sua \textit{``Gem''}\footnote{\url{httpttp://www.akitaonrails.com/2009/2/2/entendendo-rubygems}} no repositório oficial do Rails\footnote{\url{https://rubygems.org/}} para uso de outros desenvolvedores. O endereço completo para a \textit{Gem} do SocialFramework é \url{https://rubygems.org/gems/social_framework}.

Para comprovação do funcionamento do \textit{framework}, este trabalho se propôs a desenvolver uma rede social que faça uso do mesmo. Esta rede faz uso dos principais recursos providos pelo \textit{framework}. Possibilitando assim, avaliar o seu uso na prática.
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.35]{figuras/proposta/ruby_social_network.eps}
