...
Este capílo apresentou todos os pontos pertinentes para um entendimento inicial da proposta deste trabalho como um todo. A partir do que foi descrito poderão ser desenvolvidos os próximos capítulos buscando um melhor entendimento e detalhamento do tema proposto.

No próximo capítulo será apresentado o referencial teórico que aborda os temas envolvidos neste trabalho, este referncial pode ser alterado futuramente ao se deparar com assuntos não pensados anteriormente em um futuro desenvolvimento.
