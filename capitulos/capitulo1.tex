...
\begin{itemize}
	...
	\item ~\nameref{chapter:Suporte_Tecnologico}: Exposição das principais ferramentas e tecnologias que serão utilizadas no decorrer deste trabalho.
	\item ~\nameref{chapter:Metodologia}: Apresentação de como será conduzido o trabalho, abordando modelos de desenvolvimento e modelos de pesquisa utilizados.
	\item ~\nameref{chapter:Proposta}: Apresentação completa do que este trabalho se propõe a fazer.
	\item ~\nameref{chapter:Consideracoes_Finais}: Apresentação dos resultados conquistados até o momento bem como de como se dará a continuidade do desenvolvimento.
\end{itemize}
