...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.35]{figuras/capitulo1/Konigsberg.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.25]{figuras/capitulo1/sete_pontes.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.3]{figuras/capitulo1/exemplo_grafo.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.45]{figuras/capitulo1/matriz.eps}
