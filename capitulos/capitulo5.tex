...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.8]{figuras/capitulo5/graficos/network/tempo/sugerir.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.8]{figuras/capitulo5/graficos/network/memoria/build_memoria.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.8]{figuras/capitulo5/graficos/schedule/tempo/dias/31dias_tempo.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.8]{figuras/capitulo5/graficos/schedule/memoria/dias/31dias_memoria.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.8]{figuras/capitulo5/graficos/schedule/tempo/users/500users_tempo.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.8]{figuras/capitulo5/graficos/schedule/memoria/users/500users_memoria.eps}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.5]{figuras/capitulo5/gpa.eps}
	\caption[GPA]{GPA}
	\label{GPA}
\end{figure}
