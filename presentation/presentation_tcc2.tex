...
\begin{itemize}
	...
	\item Algoritmo inteligente para buscar a melhor opção para a rota secundária;
...
\begin{itemize}
	...
	\item Caso a rota secundária não possa ser alterada as rotas são imcompatíveis.
\end{itemize}
