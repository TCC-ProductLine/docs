...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.45]{../figuras/metodologia/processo_tcc.eps}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.35]{../figuras/metodologia/processo_desenvolvimento.eps}
\end{figure}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.4]{../figuras/proposta/rota.eps}
