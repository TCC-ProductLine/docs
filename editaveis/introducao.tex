...
Foi desenvolvido o \nameref{chapter:SocialFramework} para responder essa questão, além da rede social \nameref{sec:SocialBike} para um uso comprovado dos recursos fornecidos pelo \textit{framework}. A documentação completa desses, assim como, os resultados encontrados no desenvolvimento pode ser encontrada nos capítulos 6 e 7 deste trabalho.
...
\begin{itemize}
	...
	\item ~\nameref{chapter:Suporte_Tecnologico}: Apresenta todas as principais ferramentas utilizadas para desenvolvimento deste trabalho;
